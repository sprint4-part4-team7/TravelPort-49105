  ...
  return (
    <div className="relative">
      ...
      <div className="hidden md:flex space-x-[1.2rem]">
        <button
          type="button"
          className="box-border border-1 border-[#356EFF] border-solid md:p-[0.75rem] p-[0.9rem] rounded-4 text-[#356EFF] text-[1.4rem] font-semibold leading-[142%]"
        >
          파트너 페이지
        </button>
        <button
          type="button"
          className="bg-[#356EFF] text-white md:p-[0.85rem] p-[1rem] rounded-4 text-[1.4rem] font-semibold leading-[142%]"
      ...
      {/* 모바일 환경에서 햄버거 아이콘 */}
      {isMenuOpen && (
        <div className="absolute top-0 left-0 z-50 flex flex-col items-center justify-center w-full h-full bg-white md:hidden">
          <button
            type="button"
